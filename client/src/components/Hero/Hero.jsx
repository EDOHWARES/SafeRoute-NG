...
const Hero = () => {
  return (
    <section className='hero flex flex-col items-center justify-center text-center bg-cover bg-bottom bg-no-repeat h-[90vh] w-full mt-[-1rem]'>
        ...
        Empowering transporters to make safer journeys. <br /> Report road conditions, earn airtime incentives, <br /> and stay informed with real-time SMS updates – all in one place.
        </p>
        <Link to='/dashboard'>
